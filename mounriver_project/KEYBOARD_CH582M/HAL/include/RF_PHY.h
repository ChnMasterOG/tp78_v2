 ...
 *******************************************************************************/
  ...
  #define SBP_RF_SWITCH_REPORT_EVT     0x40
  #define SBP_RF_JUMPBOOT_REPORT_EVT   0x80
  #define SBP_RF_HEARTBEAT_REPORT_EVT  0x100
  #define SBP_RF_CHECK_SEND_REPORT_EVT 0x200
