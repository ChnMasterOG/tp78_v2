...
typedef enum {
  ...
  VIA_ID_DYNAMIC_KEYMAP_MAGNET_GET_BUFFER = 0x22,
  VIA_ID_DYNAMIC_KEYMAP_MAGNET_SET_BUFFER = 0x23,
  VIA_ID_DYNAMIC_KEYMAP_MAGNET_GET_VALUE = 0x24,
  VIA_ID_DYNAMIC_KEYMAP_MAGNET_SET_VALUE = 0x25,
